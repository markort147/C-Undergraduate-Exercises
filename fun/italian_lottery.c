...
int main()
{
  ...
  srand(time(0));
  /*intro*/
  printf("Questo programa simula il Superenalotto, estraendo e confontando N sestine con quella vincente. Infine tutte le giocate verrano scritte sul file ''giocate.dat''\n");
  ...
  {
    printf("Impossibile aprire il file ''giocate.dat''. Il programma verrà terminato.");
    exit(EXIT_FAILURE);
  }
