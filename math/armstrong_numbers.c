...
int main()
{
  ...
  /*intro*/
  printf("Questo programma cerca tutti quei numeri interi naturali minori di Nmax che risultano essere la somma dei cubi delle cifre decimali che li compongono, li scrive in un file ''numeriC.dat'' e stampa a schermo il numero max e il numero min trovati.\n");
  /*acquisico nmax*/
