...
int main() {
  ...
  /*intro*/
  printf(
      "Questo programma simula, in maniera semplificata, la collisione tra due "
      "fasci di particelle.\nUna singola collisione avviene quando una "
      "particella del primo fascio cade in un cerchio incentrato in una "
      "particella del secondo fascio, di raggio definito dall'utente\n");
  ...
  if ((fp = fopen("beam1.dat", "w")) != NULL) {
    ...
    printf(
        "Impossibile aprire il file 'beam1.dat'.\nIl programma proseguirà "
  ...
  printf(
      "Numero di collisioni: %d\nPercentuale di collisioni rispetto alle "
      "particelle del secondo fascio: %lf\n",
      col, 100 * col / N2);
  /*uscita*/
  exit(0);
} /*fine main*/
